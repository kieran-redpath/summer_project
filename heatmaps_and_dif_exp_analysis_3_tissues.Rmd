---
title: "heatmaps_and_dif_exp_analysis_3_tissues"
author: "Kieran Redpath"
date: "13 December 2019"
output: github_document
---

# THIS VERSION HAS SOME CHANGES FROM "dasatinib_dif_exp_analysis_29_11_19" and other similar documents.
# expDat is filtered to only include breast, gastric, and colorectal tissues, but the rest of the analyses
# etc are the same.

# DON'T USE ANY OF THIS CODE YET, EVEN TO MAKE A .md. THERE'S NO POINT, IT'S IDENTICAL TO MY OTHER DOCUMENT
...
###!!! NEEDS TO CHANGE IN HERE SOMEWHERE !!!###
# expDat_sort is used for differential expression analysis, which we need to be tissue specific.
# Need to add cell line tissue info to dasatinib$CELL_LINE_NAME and/or commonSamples, and use this to change what expDat_sort actually does
# THIS WILL GIVE YOU DIFFERENT RESULTS FOR DIFFERENTIAL EXPRESSION ANALYSIS, SO WHICH GENES ARE SIGNIFICANT
# YOU'LL HAVE TO CHANGE STUFF FURTHER DOWN AS WELL, SO THAT THE HEATMAPS ALSO ONLY INCLUDE THESE THREE TISSUES

###!!! BASICALLY, YOU NEED TO FILTER TWICE- SO THE TWO COMPONENTS OF THE HEATMAPS (THE SIGNIFICANT GENES AND THE CORRECT CELL LINES) ARE BOTH BASED ON THE 3 TISSUES YOU'RE INTERESTED IN. !!!###
...
tis <- lapply(strsplit(colnames(expDat), "_"), function(x) paste0(x[-1], collapse="_", sep="")) %>%
  unlist()
table(tis)
