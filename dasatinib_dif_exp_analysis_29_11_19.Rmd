...
```{r GoSeq Analysis for top 2100 genes}
## Load packages
library(reactome.db)
library(goseq)
library(gplots)
...
Between the two slightly different lists (different fold changes), gives you:
ECM, Collagen, Integrin, Interleukin, Interferon, Immune System, Cytokine Signalling
