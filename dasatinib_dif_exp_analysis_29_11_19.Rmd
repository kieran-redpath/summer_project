...
# Filter based on significance, increased susceptibility to dasatinib, and positive correlation between AUC and "-log" IC50
SigSamples <- filter(tt3, tt3$logFC_Sign == 1, tt3$IC50_Adj_PVal < 0.01, tt3$AUC_Adj_PVal < 0.01, tt3$AUC_Sign ==1)
...
cat(na.omit(SigSamples$Gene_Symbol[1:100]),sep="\n")
