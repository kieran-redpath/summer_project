...
for(k in 1:nrow(expDat_sort)){
  ...
  ord = order(SigSamples$IC50_logFC)
...
# Order the heatmap columns by IC50 log fold change
# Filter to remove middle 50% for analysis, instead of splitting 50:50

# Both of these need to be done way earlier on