---
title: "Dasatinib_Pathway_Analysis_CDH1_33"
...
# 4.
write.csv(tt3, file = "Dasatinib_Pathway_Analysis_CDH1_33/Top_Table.csv")
...
write.csv(dasat_rPAoverrep_table, file="Dasatinib_Pathway_Analysis_CDH1_33/ReactomePA_Analysis_Results.csv")
```
...
saveRDS(SigsymbolsinPaths, file="Sig_symbols_in_Paths.Rds")
...
write.csv(SiggoseqPathways, file = "Dasatinib_Pathway_Analysis_CDH1_33/Enriched_Pathways.csv")
```
...
![](./Dasatinib_Pathway_Analysis_CDH1_33/Heatmaps/Extracellular_matrix_organization_heatmap.png)

![](./Dasatinib_Pathway_Analysis_CDH1_33/Heatmaps/MET_activates_PTK2_signaling_heatmap.png)

![](./Dasatinib_Pathway_Analysis_CDH1_33/Heatmaps/Laminin_interactions_heatmap.png)

![](./Dasatinib_Pathway_Analysis_CDH1_33/Heatmaps/MET_promotes_cell_motility_heatmap.png)

![](./Dasatinib_Pathway_Analysis_CDH1_33/Heatmaps/Non-integrin_membrane-ECM_interactions_heatmap.png)

![](./Dasatinib_Pathway_Analysis_CDH1_33/Heatmaps/ECM_proteoglycans_heatmap.png)

![](./Dasatinib_Pathway_Analysis_CDH1_33/Heatmaps/Cell_surface_interactions_at_the_vascular_wall_heatmap.png)

![](./Dasatinib_Pathway_Analysis_CDH1_33/Heatmaps/Degradation_of_the_extracellular_matrix_heatmap.png)

![](./Dasatinib_Pathway_Analysis_CDH1_33/Heatmaps/Signaling_by_MET_heatmap.png)

![](./Dasatinib_Pathway_Analysis_CDH1_33/Heatmaps/Cell_junction_organization_heatmap.png)

![](./Dasatinib_Pathway_Analysis_CDH1_33/Heatmaps/Collagen_formation_heatmap.png)

![](./Dasatinib_Pathway_Analysis_CDH1_33/Heatmaps/Regulation_of_Insulin-like_Growth_Factor_(IGF)_transport_and_uptake_by_Insulin-like_Growth_Factor_Binding_Proteins_(IGFBPs)_heatmap.png)

![](./Dasatinib_Pathway_Analysis_CDH1_33/Heatmaps/Platelet_degranulation__heatmap.png)

![](./Dasatinib_Pathway_Analysis_CDH1_33/Heatmaps/Response_to_elevated_platelet_cytosolic_Ca2+_heatmap.png)

![](./Dasatinib_Pathway_Analysis_CDH1_33/Heatmaps/Cell-Cell_communication_heatmap.png)

![](./Dasatinib_Pathway_Analysis_CDH1_33/Heatmaps/Post-translational_protein_phosphorylation_heatmap.png)

![](./Dasatinib_Pathway_Analysis_CDH1_33/Heatmaps/Hemostasis_heatmap.png)

![](./Dasatinib_Pathway_Analysis_CDH1_33/Heatmaps/Assembly_of_collagen_fibrils_and_other_multimeric_structures_heatmap.png)

![](./Dasatinib_Pathway_Analysis_CDH1_33/Heatmaps/Cell-extracellular_matrix_interactions_heatmap.png)

![](./Dasatinib_Pathway_Analysis_CDH1_33/Heatmaps/Signaling_by_Receptor_Tyrosine_Kinases_heatmap.png)