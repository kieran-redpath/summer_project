...
CDH1_Exp_Levels <- subset(expDat, rownames(expDat)=="ENSG00000039068.14")
...
CCLE_dasat_BCCCGC$CDH1_Expression[Boxplot_data] <- "YES"
...
Also do expression vs mutation status.
