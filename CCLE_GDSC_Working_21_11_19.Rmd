...
##### RUN FROM HERE. Trying to work this data (GDSC_IC50 and GDSC_AUC) to plot the relationship between the two
...
CCLElinesBCCCGC <- dplyr::select (CCLElinesBCCCGC, -c(CCLE_Name))
...
```{r Save Some Important Files for the Next Steps, echo=FALSE, include=FALSE}
