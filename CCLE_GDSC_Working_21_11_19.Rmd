...
# 26_11_19
## Not included yet cause it isn't done
...
Save some data.frames as files using save.csv, so you can just load them back in and not worry about being in the same markdown.
