...
for(k in 1:length(ensginPaths)){
  ...
  if(nrow(zz)>1){
    ...
    legend(0.4,0.97,
           c("Breast", "High -log IC50", "High AUC", "Significant", "Stomach", "Low -log IC50", "Low AUC", "Not Significant", "", "", "", ""),
           fill=c("red","yellow","yellow","green","blue","blue","blue","red","white","white","white","white"), border="white", ncol=3)
    dev.off()
  }
}
```
