...
```
## Things To Do 
Put best heatmaps inline in the markdown (check the code mik sent you)
create a heatmap of the genes that are shared between the pathways (check the code mik sent you) Use genesinPaths or ensginpaths
...
### *Print the top 20 pathways in the document*
